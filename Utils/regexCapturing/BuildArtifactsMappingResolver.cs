...
namespace JFrog.Artifactory.Utils.regexCapturing
{
    ...
    {
        public static BuildArtifactsMapping getArtifactsMapping(string input)
        {
            string[] inOut = input.Split(new String[]{"=>"}, StringSplitOptions.None);

            return new BuildArtifactsMapping(inOut[0], inOut[1]);
        }
        ...
        {           
            ...
            {
                Match fileMatcher = Regex.Match(file, regexNormalize);
